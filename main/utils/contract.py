...
class ContractUtils:
    ...
    def set_up_blockchain(self, contract: str, abi_path: str):
        """
        Purpose:
        ...
        #
        ############ Ethereum Setup ############
        PUBLIC_KEY = os.environ["WALLET_ADDRESS"]
        PRIVATE_KEY = Web3.toBytes(hexstr=os.environ["WALLET_PRIVATE_KEY"])
        INFURA_KEY = os.environ["INFURA_ETHEREUM_PROJECT_ID"]
        #
