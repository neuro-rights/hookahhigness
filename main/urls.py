...
urlpatterns = [
    ...
    path("collections/", views.NFTCollectionList.as_view(), name="collection_list"),
    ...
    path("collections/<int:collection_id>/add_raffle/", views.add_raffle, name="add_raffle"),
    ...
    path("nfts/", views.NFTList.as_view(), name="nft_list"),
